...
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd(
    [[grim ~/Pictures/screenshot/screenshot-$(date +'%Y-%m-%d_%H-%M-%S').png && notify-send "Screenshot Saved happy alle "]]))

hl.bind(mainMod .. " + X", hl.dsp.exec_cmd(
    [[grim -g "$(slurp)" ~/Pictures/screenshot/screenshot-$(date +'%Y-%m-%d_%H-%M-%S').png && notify-send "Screenshot Saved happy alle"]]))
